...
(** [replace_cache m unitpath ~source_digest value] replaces the cache associated with [unitpath] and
...
(** [find_cache m unitpath ~source_digest ~cache_digest value] finds the cache associated with [unitpath] and
